...
- `stated_month`: the month the document says it bills, when it says one. An invoice dated 07/31/2026 for a month's work, a heading like "Jul-26", or a note naming the month all count. This is the only thing that says which month is being billed, because the rows themselves span two. Leave it null when nothing on the page names a month.
